...
# Feature names (replace with your actual column names if different)
feature_names = ['City', 'PM2.5', 'PM10', 'NO', 'NO2', 'NOx', 'NH3', 'CO', 'SO2', 'O3', 'Benzene', 'Toluene', 'Xylene', 'Year', 'Month', 'Day']
...
mlp = MLPRegressor(hidden_layer_sizes=(64, 32), activation='relu', solver='adam', learning_rate_init=0.001, max_iter=500, random_state=42, warm_start=True)
...
input_data = pd.DataFrame([[city_encoded] + list(data[pollutant_columns].mean()) + [year, month, day]], columns=feature_names) 
